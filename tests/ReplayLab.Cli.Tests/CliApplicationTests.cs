...
{
    [Fact]
    public async Task RunAsync_uses_services_from_the_supplied_service_provider()
    {
        ...
        var senderFactory = new HostRecordingSenderFactory();
    ...
    private sealed class HostRecordingSenderFactory : ReplayLab.Cli.Hosting.IReplaySenderFactory
    {
        private readonly IReplaySender _sender = new MockReplaySender();
